            ...
            response
                ...
                .then(j => {
                  //  console.log(j);
                    ...
                    connection.query('INSERT INTO keyStats (id,peRatioHigh,peRatioLow,profitMargin,week52high,week52low,' +
                            ...
                            ',month3ChangePercent,marketcap,symbol) VALUES' +
                            '("' + i + '","' + j.peRatioHigh + '","' + j.peRatioLow + '","' + j.profitMargin + '","' + j.week52high + '","' + j.week52low + '","' + j.week52change + '","' + j.shortDate + '","' + j.priceToBook + '","' + j.dividendYield + '","' + j.EBITDA + '","' + j.revenue + '","' + j.grossProfit + '","' + j.cash + '","' + j.priceToSales + '","' + j.dividendRate + '","' + j.institutionPercent + '","' + j.insiderPercent + '","' + j.month1ChangePercent + '","' + j.day5ChangePercent + '","' + j.shortRatio + '","' + j.year5ChangePercent + '","' + j.year2ChangePercent + '","' + j.year1ChangePercent + '","' + j.ytdChangePercent + '","' + j.month6ChangePercent + '","' + j.month3ChangePercent + '", "' + j.marketcap + '", "' + j.symbol + '")', (err, result) => {});
